...
object GameView {
	...
	private final val RULE_OPTION_1 = 4
	private final val RULE_OPTION_2 = 5
	...
	private def printOptions() {
		...
		option match {
			...
			case HALT => halt()
			case RULE_OPTION_1 => selectEngine_1()
			case RULE_OPTION_2 => selectEngine_2()

		}
	}
	private def selectEngine_1() = GameController.selectEngine_1()

	private def selectEngine_2() = GameController.selectEngine_2()
	...
	def parseOption(option: String): Int = option match {
		...
		case "3" => HALT
		case "4" => RULE_OPTION_1
		case "5" => RULE_OPTION_2
