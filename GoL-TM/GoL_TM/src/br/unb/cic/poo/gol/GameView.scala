...
object GameView {
	...
	private final val ENGINE_1 = 3
	private final val ENGINE_2 = 4
	private final val HALT = 5

	private def GameEngine = GameController.GameEngine
	private def selectEngine1 = GameController.selectEngine1
	private def selectEngine2 = GameController.selectEngine2
	...
	private def printOptions {
		...
		option match {
			...
			case ENGINE_1 => selectEngine1
			case ENGINE_2 => selectEngine2
			case HALT => halt
		}
	}
